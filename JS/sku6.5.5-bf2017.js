window.onload = function(){
  ...
  $(document).ready(function(){
    ...
    //     // getSkuVariacao();
    // });
    // $(".resultItemsWrapper .shelf.productList").each ( function () {
    //   var nChildren = $(this).find('.shelf.productList').length;
    //   newProductsLoaded.observe (this, {childList: true, characterData: true, attributes: true, subtree: true });
    // } );
